...
public class FieldMap {
    ...
    static {
        ...
        startPositions[0] = new Pose2d(startLineX * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - targetCenterPointY) * Constants.inchToMetersConversionFactor,  new Rotation2d(0.0));        // directly centered
        startPositions[1] = new Pose2d(startLineX * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - targetCenterPointY + 35) * Constants.inchToMetersConversionFactor, new Rotation2d(0.0));   // offcenter by 35 inches
        ...
        startPositions[3] = new Pose2d(startLineX * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - friendlyTrenchY) * Constants.inchToMetersConversionFactor,  new Rotation2d(0.0));            // facing trench
        startPositions[4] = new Pose2d(startLineX * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - 220.341) * Constants.inchToMetersConversionFactor, new Rotation2d(0.0)); // centered in front of enemy feeder station
        //locations of balls
        //Positions of balls 1-12 on the field
        ballPosition[0] = new Translation2d(378.959 * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - enemyTrenchBall1Y) * Constants.inchToMetersConversionFactor);  
        ballPosition[1] = new Translation2d(378.959 * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - enemyTrenchBall2Y) * Constants.inchToMetersConversionFactor);
        ...
        ballPosition[7] = new Translation2d(386.688 * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - friendlyTrenchY) * Constants.inchToMetersConversionFactor);    
        ballPosition[8] = new Translation2d(350.688 * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - friendlyTrenchY) * Constants.inchToMetersConversionFactor);     
        ballPosition[9] = new Translation2d(314.688 * Constants.inchToMetersConversionFactor,(bottomLeftCornerConversion - friendlyTrenchY) * Constants.inchToMetersConversionFactor);
