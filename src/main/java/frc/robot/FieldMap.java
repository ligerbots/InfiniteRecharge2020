...
public class FieldMap {
    ...
    static {
        ...
        startPositions[1] = new Pose2d(startLineX, bottomLeftCornerConversion - targetCenterPointY + 35.0 * Constants.inchToMetersConversionFactor, new Rotation2d(0.0));   // offcenter by 35 inches
        startPositions[2] = new Pose2d(startLineX, bottomLeftCornerConversion - targetCenterPointY - 35.0 * Constants.inchToMetersConversionFactor, new Rotation2d(0.0));   // offcenter by -35 inches
